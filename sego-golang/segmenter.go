...
func (seg *Segmenter) LoadDictionaryFromStr (str string)  {
	seg.dict = NewDictionary()

	reader := strings.NewReader(str)
	readTokenStrings(reader, seg.dict)
...
func (seg *Segmenter) LoadDictionary(files string) {
	...
	for _, file := range strings.Split(files, ",") {
		...
		readTokenBufio(reader, seg.dict)
	}
	setToken(seg)
	log.Println("sego词典载入完毕")
}
...
func readTokenBufio(reader *bufio.Reader, dict *Dictionary)  {
...
func readTokenStrings(reader *strings.Reader, dict *Dictionary)  {
